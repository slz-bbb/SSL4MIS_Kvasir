...
from dataloaders.KvasirSets import BaseDataSets, RandomGenerator, TwoStreamBatchSampler
...
parser.add_argument('--root_path', type=str,
                    default=r'D:\datasets\STARE\training_pro', help='Name of Experiment')
parser.add_argument('--exp', type=str,
                    default='STARE_test128182/5%labeled/URPC', help='experiment_name')
...
parser.add_argument('--patch_size', type=list,  default=[48, 48],
...
parser.add_argument('--labeled_num', type=int, default=8272,
                    help='labeled data')
# costs
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            if iter_num > 0 and iter_num % 200 == 0:
                ...
                # print(dice_class)
                # print(dice_class[2])
                performance = sum(dice_class) / len(dice_class)
