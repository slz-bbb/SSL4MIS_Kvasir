...
from dataloaders.KvasirSets import (BaseDataSets, RandomGenerator,
...
parser.add_argument('--root_path', type=str,
                    default=r'D:\datasets\Kvasir\for_SSL4MIS', help='Name of Experiment')
parser.add_argument('--exp', type=str,
                    default='Kavsir/20%labeled/CPS', help='experiment_name')
...
parser.add_argument('--patch_size', type=list,  default=[352, 352],
...
parser.add_argument('--labeled_num', type=int, default=160,
                    help='labeled data')
# costs
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            if iter_num > 0 and iter_num % 200 == 0:
                ...
                # print(dice_class)
                # print(dice_class[2])
                performance1 = sum(dice_class) / len(dice_class)
                ...
                # print(dice_class)
                # print(dice_class[2])
                performance2 = sum(dice_class) / len(dice_class)
